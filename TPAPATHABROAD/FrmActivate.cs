...
namespace TPA
{
    public partial class FrmActivate : Form
    {
        ...
        private const string ACTIVATION_BASE_URL = "http://www.pathabroad.com/pas/activate.aspx";
        ...
        private void btnValidateLicenseFile_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    MessageBox.Show("Path Abroad Test Series has been activated successfully. Please restart your Path Abroad application.",
                        "Path Abroad activation successful",MessageBoxButtons.OK,MessageBoxIcon.Information,
